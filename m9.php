...
<html>
	<head>
		...
		function gotoNewUrl(xLink,DueDate) {
			...
			function gotoUrlDetail(xLink,DueDate) {
				location.href = xLink+"?xDate="+DueDate+"&xUrl=m9.php";
			}
    ...
    <a href="#" onClick='gotoUrlDetail("Customer_m9.php","<?=$eDate?>");' data-role="button" data-theme="b">แสดงรายละเอียด</a>
...
<div data-role="footer">
			<a href="#" onClick='gotoUrl("m9.php","<?=$eDate?>",1);' class="ui-btn-left ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-left ui-icon-circle-triangle-w ui-icon-arrow-l">Previous</a>
            		<h1>FAI BAKERY CHIANGMAI</h1>
			<a href="#" onClick='gotoUrl("m9.php","<?=$eDate?>",2);' class="ui-btn-right ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right ui-icon-arrow-r">Next</a>
		</div>
</div>
