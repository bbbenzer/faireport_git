...
<html>
    ...
    <fieldset data-role="controlgroup" data-mini="true">
    	<input type="radio" name="radio-mini" id="radio-mini-1" value="choice-1"  onClick='gotoFilter("m3_1_1.php","<?=$eDate?>",1,5,"<?=$xItc?>","<?=$xUrl?>","<?=$xUrl2?>","<?=$CusCode?>","<?=$flag?>");'/>
    	<label for="radio-mini-1">เรียงตามราคา</label>

		<input type="radio" name="radio-mini" id="radio-mini-2" value="choice-2"  checked="checked"onClick='gotoFilter("m3_1_1.php","<?=$eDate?>",2,5,"<?=$xItc?>","<?=$xUrl?>","<?=$xUrl2?>","<?=$CusCode?>","<?=$flag?>");'/>
    	<label for="radio-mini-2">เรียงตามห้อง/ราคา</label>
	</fieldset>
<? }else{ ?>
    <fieldset data-role="controlgroup" data-mini="true">
    	<input type="radio" name="radio-mini" id="radio-mini-1" value="choice-1" checked="checked" onClick='gotoFilter("m3_1_1.php","<?=$eDate?>",1,5,"<?=$xItc?>","<?=$xUrl?>","<?=$xUrl2?>","<?=$CusCode?>","<?=$flag?>");'/>
    	<label for="radio-mini-1">เรียงตามราคา</label>

		<input type="radio" name="radio-mini" id="radio-mini-2" value="choice-2"  onClick='gotoFilter("m3_1_1.php","<?=$eDate?>",2,5,"<?=$xItc?>","<?=$xUrl?>","<?=$xUrl2?>","<?=$CusCode?>","<?=$flag?>");'/>
    	<label for="radio-mini-2">เรียงตามห้อง/ราคา</label>
	</fieldset>
<? } ?>
