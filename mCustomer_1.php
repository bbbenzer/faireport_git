	...
	<body>
 	<div data-demo-html="true">
		<div data-role="header">
			...
			<?php } else{
				?> <a href="#" onClick='gotoMenu("m3_1_1.php","<?=$eDate?>","<?=$xItc?>","<?=$xUrl2?>","<?=$CusCode?>","<?=$xUrl?>","<?=$flag?>");' class="ui-btn-left ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-left ui-icon-circle-triangle-w ui-icon-carat-l">Back</a>
			<?php } ?>
