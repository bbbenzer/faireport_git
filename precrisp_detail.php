	...
	<body>
 	<div data-demo-html="true">
		<div data-role="header">
			...
			<a href="#" onClick="gotoNewUrl('precrisp-detail_print.php','<?=$DueDate?>','<?=$eDate?>','<?=$NameTH?>');" class="ui-btn-right ui-btn ui-btn-b ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right ui-icon-grid">Print</a>
		</div>
	</div>
