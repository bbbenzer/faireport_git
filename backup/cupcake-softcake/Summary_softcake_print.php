...
<center><b style="font-size: 24">รายงานขนมห้องซอฟต์เค้ก</b>
  ...
  <?php
    ...
    $Sql_sub = "SELECT NameTH,SalePrice,SUM(sd.Qty) AS QtyOrder,CONCAT(FName,'  ',LName) AS Customer,
                ...
                while ($Result = mysql_fetch_assoc($meQuery2)) {
                  ...
                  <div class="ui-block-a" style="font-size:15px; font-weight:normal; width:100%">
                    <div align="left">
                      <?=$Result["Customer"]?> &nbsp;&nbsp; จำนวน <?=$Result["QtyOrder"]?>
                    </div>
                  </div>
                  <div class="ui-block-b" style="font-size:15px; font-weight:normal; width:0%">
                    <div align="right">
                    </div>
                  </div>
                  </fieldset>
